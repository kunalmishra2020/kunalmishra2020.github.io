export const user = {
	...
	skills: ['NodeJs', 'Amazon Web Services (AWS)', 'TypeScript', 'JavaScript', 'Python', 'MongoDB', 'PostgreSQL', 'Git'],
	contacts: [
		{
			url: 'https://github.com/kunalmishra2020',
			type: 'github' as const,
		},
		{
			url: 'https://www.linkedin.com/in/kunalmishra2020',
